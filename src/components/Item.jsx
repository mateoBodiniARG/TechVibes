        ...
        <div className="mt-4 px-5 pb-5">
          ...
          <div className="mt-2 mb-5 flex items-center justify-center">
            <p>
              ...
              <span className="text-sm text-red-600 line-through ml-2">{discount}</span>
            </p>
          </div>
          <a
            href="#"
            className="flex items-center justify-center rounded-md bg-slate-900 py-2.5 text-center text-sm font-medium text-white transition ease-in hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            <svg
