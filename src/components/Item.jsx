    ...
    <section className="p-2">
      <div className="mt-1 flex flex-col border border-gray-600 bg-gray-800 rounded-xl">
        ...
        <div className="mt-4 px-5 pb-5">
          ...
          <Link
            to={`/item/${id}`}
            className="flex items-center justify-center rounded-md bg-indigo-600 py-2.5 text-center text-sm font-medium text-white transition ease-in hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
